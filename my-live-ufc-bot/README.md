...
Notification-only Polymarket UFC moneyline monitor. It watches live CLOB top-of-book prices and sends a Pushover alert when a fighter can be bought at `0.01` or lower.
...
UFC_LIVE_ALERT_PRICE=1.00 python monitor_live_ufc_odds.py all --no-notify --seed-only
```
